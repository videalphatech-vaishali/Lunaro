...
<body>
    <style>
        * {
        ...
        /* Section Container */
        .commodities-start-trading-section {
        ...
        .commodities-start-trading-container {
        ...
        /* Left Side */
        .commodities-start-trading-left h1 {
            font-size: 2.6rem;
            font-weight: 700;
            margin-bottom: 15px;
        }

        .commodities-start-trading-left p {
            color: #b6b8c7;
            font-size: 1rem;
            font-weight: 400;
            margin-bottom: 35px;
        ...
        /* Right Side Features */
        .commodities-start-trading-right {
    ...
    <section class="commodities-start-trading-section">
        <div class="commodities-start-trading-container">
            <!-- Left Content -->
            <div class="commodities-start-trading-left">
                <h1>Start trading now</h1>
                <p>Open your Lunaro Markets account today and gain access to the world's most recognized commodities with
            ...
            <!-- Right Features -->
            <div class="commodities-start-trading-right">
                <div class="feature">
                    <div class="icon">
                    ...
                    <p><strong>Access to Precious Metals, Energy, and Agricultural Markets</strong> <br>
