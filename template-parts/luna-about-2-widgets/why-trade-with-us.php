...
<div class="about-wtwu-section">
    ...
    <div class="about-row-body">
        ...
        <div class="bg-[#FFF4E433] p-6 rounded-3xl shadow-lg border border-gray-700 hover:border-purple-500 transition">
          ...
          <h3 class="text-2xl font-bold mb-4" style="letter-spacing: -0.78px;">Regulated & Secure</h3>
        ...
        <div class="bg-[#FFF4E433] p-6 rounded-3xl shadow-lg border border-gray-700 hover:border-purple-500 transition">
          ...
          <h3 class="text-2xl font-bold mb-4">Institutional-Grade Infrastructure</h3>
          <p class="text-gray-300 text-sm leading-relaxed">
        ...
        <div class="bg-[#FFF4E433] p-6 rounded-3xl shadow-lg border border-gray-700 hover:border-purple-500 transition">
          ...
          <h1 class="text-2xl font-bold mb-4">Powerful Trading Platforms</h1>
          <p class="text-gray-300 text-sm leading-relaxed">
