	...
	var self = this,
		...
		pushColor = function () {
			var colorObj = new Color( {
				...
				getScore = function (
					contrastBackground,
					contrastSurroundingText
				) {
					var diffBackground =
							7 >= contrastBackground
								? 0
								: 7 - contrastBackground,
						diffSurroundingText =
							3 >= contrastSurroundingText
								? 0
								: 3 - contrastSurroundingText;
			...
			item = {
				color: colorObj,
				contrastBackground: colorObj.getDistanceLuminosityFrom(
					self.bgColorObj
				),
				contrastText: colorObj.getDistanceLuminosityFrom(
					self.textColorObj
				),
			};
