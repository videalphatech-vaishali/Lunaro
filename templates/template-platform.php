...
<body style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/images/blue_backgorund.png);">
    ...
    <section class="hero-section">
        ...
        <p>Trade Anytime, Anywhere with Our Advanced Platforms. Access professional-grade trading technology through
            MetaTrader 5, CQG, TT and Rithmic, designed to give you complete control over your trading experience across
            all
            devices and markets.</p>
        <h2>Overview</h2>
        <p class="overview">Choose from our comprehensive suite of trading platforms designed to meet every trading
            style
            and preference. Whether you prefer the advanced capabilities of MetaTrader 5 or the convenience of mobile
            trading,
    ...
    <section class="platform-section">
        <div class="platform-grid">
            ...
            <div class="platform-card">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/other-platforms.png"
                    alt="Other Platforms">
   ...
   ?>
    ...
    <section class="hero-section">
        ...
        <p>Trade Anytime, Anywhere with Our Advanced Platforms. Access professional-grade trading technology through
            MetaTrader 5,
            our mobile applications, and web-based solutions designed to give you complete control over your trading
            experience across
            all devices and markets.</p>
        <h2>Overview</h2>
        <p class="overview">Choose from our comprehensive suite of trading platforms designed to meet every trading
            style and
            preference. Whether you prefer the advanced capabilities of MetaTrader 5 or the convenience of mobile
            trading, our
            platforms deliver institutional-quality tools with user-friendly interfaces.</p>
    </section>
    <section class="platform-section">
        <div class="platform-grid">
            <div class="platform-card">
            ...
            <div class="platform-card">
                ...
                <h1 style="margin-bottom: 10px;">Mobile App</h1>
                <p>On-the-go trading, real-time notifications, and user-friendly design.</p>
                <h3 style="margin-top: 10px; color: white;">Key Features:</h3>
                <ul>
                    <li>Professional technical analysis on mobile devices</li>
                    <li>Account control and trade history monitoring</li>
                    <li>Multi-asset trading platform for Forex and Exchange markets</li>
                    <li>Available for iOS and Android smartphones and tablets</li>
                    <li>Touch screen optimised with comfortable night theme</li>
                </ul>
                <a href="#" style="margin-bottom: 20px;">Learn about the Lunaro mobile app →</a>
            </div>
        </div>
    </section>
    ...
    <section class="main-advanced">
        <div class="advanced-section">
            <div class="advanced-text">
                ...
                <p>Our trading platforms are designed to provide institutional-grade functionality with retail-friendly
                    accessibility, ensuring you have every tool needed for successful trading across all market
                    conditions.</p>
            </div>
            <div class="advanced-img">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/advanced-platforms.png"
    ...
    <section class="main-faq">
        <div class="faq-tutorials">
            ...
            <div class="faq-grid">
                ...
                <!-- FAQ Card -->
                <div class="faq-card">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/faq-question.png"
                        alt="FAQs Image">
                    <h3>FAQs</h3>
                    <p>Get instant answers to common questions about our trading platforms, from basic navigation to
                        advanced
                        features. Our comprehensive FAQ section covers platform installation, account setup, trading
                        functionality,
                ...
                <div class="faq-card">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/Mask2.png"
                        alt="Tutorials Image">
                    <h3>Tutorials</h3>
                    <p>Master our trading platforms with step-by-step tutorials covering everything from basic
                        navigation to advanced trading strategies. Our expert-created guides help you maximize platform
            ...
            <div class="start-right">
                <div class="start-feature">
                    <div class="icon-circle"><img
                            src="<?php echo get_template_directory_uri(); ?>/assets/images/lightning-01.svg" alt="">
                    </div>
                    <div>
                ...
                <div class="start-feature">
                    <div class="icon-circle"><img
                            src="<?php echo get_template_directory_uri(); ?>/assets/images/lock-01.svg" alt=""></div>
                    <div>
                ...
                <div class="start-feature">
                    <div class="icon-circle"><img
                            src="<?php echo get_template_directory_uri(); ?>/assets/images/message-chat-square.svg"
                            alt=""></div>
                    <div>
